...
EXAMPLE_WORKFLOWS: tuple[ExampleWorkflowSpec, ...] = (
    ExampleWorkflowSpec(
        ...
        "Inspect image and measurement tools in one seven-lane workflow with "
    ...
    ExampleWorkflowSpec(
        ...
        "conversion, filtering, fixed thresholding, boolean cleanup, and 3D "
        "connected components. Prefer GPU remains portable because every "
        "fallback is visible.",
    ),
    ExampleWorkflowSpec(
        "object-intensity",
