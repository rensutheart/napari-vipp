...
Last reviewed: 2026-09-06. Target Windows release: `0.15.0a1`; the focused
...
This form covers only the Windows `.exe`. `0.15.0a1` also targets separate
...
Introduced in `0.13.0a8` and retained through `0.15.0a1`, Windows supplies
