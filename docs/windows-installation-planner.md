...
VIPP `0.15.0a1` retains both the read-only
...
Introduced in `0.13.0a8` and retained through the current `0.15.0a1`, one-click
managed setup calls
...
VIPP `0.15.0a1` keeps setup activity inspectable throughout this work.
